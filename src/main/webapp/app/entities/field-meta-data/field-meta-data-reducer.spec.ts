...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDMETADATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDMETADATA actions', async () => {
      const expectedActions = [
        {
