...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDSUBMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDSUBMISSION actions', async () => {
      const expectedActions = [
        {
