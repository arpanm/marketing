...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './promotion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROMOTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROMOTION actions', async () => {
      const expectedActions = [
        {
