  ...
  return (
    <div>
      <h2 id="option-heading" data-cy="OptionHeading">
        <Translate contentKey="marketingApp.option.home.title">Options</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="marketingApp.option.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/option/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="marketingApp.option.home.createLabel">Create new Option</Translate>
          </Link>
        </div>
      </h2>
          ...
          {optionList && optionList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="marketingApp.option.field">Field</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="marketingApp.option.home.notFound">No Options found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
