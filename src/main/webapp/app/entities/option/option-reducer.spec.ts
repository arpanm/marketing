...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './option.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPTION actions', async () => {
      const expectedActions = [
        {
