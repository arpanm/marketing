...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMSUBMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORMSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORMSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORMSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORMSUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORMSUBMISSION actions', async () => {
      const expectedActions = [
        {
