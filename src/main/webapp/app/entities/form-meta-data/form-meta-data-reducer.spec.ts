...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMMETADATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORMMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORMMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORMMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORMMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORMMETADATA actions', async () => {
      const expectedActions = [
        {
